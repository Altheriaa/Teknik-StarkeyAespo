...
namespace App\Filament\Resources\KurikulumSis;

use App\Filament\Resources\KurikulumSis\Pages\ManageKurikulumSis;
...
class KurikulumSiResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Kurikulum Sistem Informasi FT-Unaya';
    ...
    {
        return [
            'index' => ManageKurikulumSis::route('/'),
        ];
    }
}
