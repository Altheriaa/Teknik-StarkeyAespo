...
namespace App\Filament\Resources\KegiatanHimasis;

use App\Filament\Resources\KegiatanHimasis\Pages\ManageKegiatanHimasis;
...
class KegiatanHimasiResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Kegiatan Himasi';
    ...
    {
        return [
            'index' => ManageKegiatanHimasis::route('/'),
        ];
    }
}
