...
namespace App\Filament\Resources\PenghargaanMahasiswas;

use App\Filament\Resources\PenghargaanMahasiswas\Pages\ManagePenghargaanMahasiswas;
...
class PenghargaanMahasiswaResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Penghargaan Mahasiswa';
    ...
    {
        return [
            'index' => ManagePenghargaanMahasiswas::route('/'),
        ];
    }
}
