...
namespace App\Filament\Resources\DosenSipils;

use App\Filament\Resources\DosenSipils\Pages\ManageDosenSipils;
...
class DosenSipilResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Dosen Sipil';

    protected static ?string $pluralModelLabel = 'Dosen Sipil FT-Unaya';
