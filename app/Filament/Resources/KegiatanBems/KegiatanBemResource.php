...
namespace App\Filament\Resources\KegiatanBems;

use App\Filament\Resources\KegiatanBems\Pages\ManageKegiatanBems;
...
class KegiatanBemResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Kegiatan BEM';
    ...
    {
        return [
            'index' => ManageKegiatanBems::route('/'),
        ];
    }
}
