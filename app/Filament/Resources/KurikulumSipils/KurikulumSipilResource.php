...
namespace App\Filament\Resources\KurikulumSipils;

use App\Filament\Resources\KurikulumSipils\Pages\ManageKurikulumSipils;
...
class KurikulumSipilResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Kurikulum Teknik Sipil FT-Unaya';
    ...
    {
        return [
            'index' => ManageKurikulumSipils::route('/'),
        ];
    }
}
