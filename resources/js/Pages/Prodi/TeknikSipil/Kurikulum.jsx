...
export default function KurikulumTeknikSipil({ kurikulumSipils , groupedKurikulum , sksPerSemester , totalSks , buku }) {

    return (    
        <HomeLayout header="Kurikulum Teknik Sipil">
            <section className="hero">
                <div className="container-hero text-center">
                    <h1 className="display-4 fw-bold fade-in">Kurikulum</h1>
                    <p className="lead fade-in">Teknik Sipil</p>
                </div>
            </section>

            <h1 className="kurikulum-h1">Akademik S-1 Teknik Sipil</h1>
                    ...
                    <table className="kurikulum-table">
                        ...
                        {Object.entries(groupedKurikulum).map(([semester, kurikulumList]) => (
                            <React.Fragment key={semester}>
                                {Object.values(kurikulumList).map((kurikulumSipil, index) => (
                                    <tr key={`${semester}-${index}`}>
                                        ...
                                        <td>
                                            {kurikulumSipil.rps ? (
                                                <a href={kurikulumSipil.rps} target="_blank" rel="noreferrer" className="btn">
