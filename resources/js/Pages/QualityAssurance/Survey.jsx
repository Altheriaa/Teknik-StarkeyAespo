...
export default function Survey({ Surveys, filters }) {
    ...
    useEffect(() => {
        ...
        const delayDebounceFn = setTimeout(() => {
            router.get('/survey', { search: searchTerm }, {
                preserveState: true,
                preserveScroll: true,
                replace: true,
            });
    ...
    return (
        <HomeLayout header="Survey">
            <section className="hero">
                <div className="container-hero text-center">
                    <h1 className="display-4 fw-bold fade-in">Survey</h1>
                        ...
                        <table className="download-table table table-hover" id="sop-download-table">
                            <thead className="download-table-header table-dark">
                                <tr>
                                    ...
                                    <th className="download-col-name">JENIS SURVEY</th>
                            ...
                            <tbody className="download-table-body">
                                {Surveys.data.map((Survey, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className='text-center'>{Survey.date}</td>
                                        <td className="text-center"><a href={Survey.link} target='_blank'
